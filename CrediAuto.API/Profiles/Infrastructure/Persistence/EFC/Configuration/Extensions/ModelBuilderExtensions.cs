...
namespace CrediAuto.API.Profiles.Infrastructure.Persistence.EFC.Configuration.Extensions;
...
public static class ModelBuilderExtensions
{
    public static void ApplyProfilesConfiguration(this ModelBuilder builder)
    {
        ...
        builder.Entity<Profile>().Property(p => p.UserId).IsRequired().HasColumnName("UserId");
